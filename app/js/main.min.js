...
//! form
//! menu
const e=document.querySelector(".burger"),t=document.querySelector(".main"),a=document.querySelector(".header__menu"),i=document.querySelector(".header__img");let s=!1;e.addEventListener("click",()=>{1==s?([e,t,i,a].forEach(e=>e.classList.remove("active")),s=!1):((e=>{e.forEach(e=>e.classList.add("active"))})([e,t,i,a]),s=!0)}),console.log(document.documentElement.clientWidth);new Swiper(".header__subtitle",{direction:"vertical",loop:!0});document.querySelector(".header").addEventListener("mousemove",e=>{let a=this.querySelectorAll("[data-speed]");for(let i of a){let a=i.getAttribute("data-speed");i.classList.contains("header__img")&&!i.classList.contains("active")&&(i.style.transform=`translate(-${e.clientX/a}px, -${e.clientY/a}px)`),i.classList.contains("main__parallax-bg")&&!t.classList.contains("active")&&(i.style.transform=`translate(-${e.clientX/a}px, -${e.clientY/a}px)`)}});
//! play
const r=document.querySelector(".play"),n=document.querySelector(".about__video");let l=!1;const o=()=>{!1===l?(r.classList.add("paused"),r.parentElement.classList.add("played"),n.play(),l=!0):(r.classList.remove("paused"),r.parentElement.classList.remove("played"),n.pause(),l=!1)};r.addEventListener("click",o),n.addEventListener("ended",()=>{n.load(),o()});(()=>{const e=document.querySelector(".header__subtitle"),t=document.querySelectorAll(".header__subtitle-item");let a=0;function i(e){e>t.length&&(a=0,t[a].style.display="block"),e<0&&(a=t.length),t.forEach(e=>{e.style.display="none",e.classList.remove("out")}),t[a].style.display="block"}i(a),e.addEventListener("click",e=>{e.target&&(t[a].classList.add("out"),i(++a))})})()}));